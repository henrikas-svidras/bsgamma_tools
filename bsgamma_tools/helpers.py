...
def mixed_dmID_to_latex(input_id):
    mixed_fei_decays = [
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} \pi^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} \pi^{+} \pi^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} \pi^{+} \pi^{0} \pi^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} \pi^{+} \pi^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} \pi^{+} \pi^{+} \pi^{-} \pi^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow \bar{D}^{0} \pi^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} D^{0} K^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} D^{0 *} K^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} D^{0} K^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} D^{0 *} K^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} D^{+} K_{S}^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} D^{+} K_{S}^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} D^{+*} K_{S}^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} D^{+*} K_{S}^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D_{s}^{+} D^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} \pi^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} \pi^{+} \pi^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} \pi^{+} \pi^{0} \pi^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} \pi^{+} \pi^{+} \pi^{-}$",
    ...
    r"$B_{\mathrm{had}}^{0} \rightarrow D_{s}^{+} D^{-*}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D_{s}^{+*} D^{-*}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow J / \psi K_{S}^{0}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow J / \psi K^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow J / \psi K_{S}^{0} \pi^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow \Lambda_{c}^{-} p \pi^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow \bar{D}^{0} p \bar{p}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-} p \bar{p} \pi^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow D^{-*} p \bar{p} \pi^{+}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow \bar{D}^{0} p \bar{p} \pi^{+} \pi^{-}$",
    r"$B_{\mathrm{had}}^{0} \rightarrow \bar{D}^{0 *} p \bar{p} \pi^{+} \pi^{-}$",
    ]
    if input_id>=len(mixed_fei_decays):
        return 'none'
    return mixed_fei_decays[input_id]
