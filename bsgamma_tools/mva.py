...
def show_separation(model, train_x, test_x, train_y, test_y, log = False, saveas = None, koeff = 1):
    ...
    b2plot.errorhist(negative_probs_train, bins = bins1,ax = axis,label='Continuum Train', fmt='v',color=sns.xkcd_rgb["denim blue"])
    b2plot.errorhist(positive_probs_train, bins = bins2,ax = axis,label='BB Train', fmt='^',color=sns.xkcd_rgb["dark red"])
